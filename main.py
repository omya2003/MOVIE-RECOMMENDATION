...
def recommend():
    ...
    if(imdb_id != ""):
        ...
        return render_template('recommend.html',title=title,poster=poster,overview=overview,vote_average=vote_average,imdb_id=imdb_id,
...
#def movies():
#    return render_template('movie.html',imdb_id=imdb_id)
